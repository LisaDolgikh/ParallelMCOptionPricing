...
Проект выполнен в рамках курса «Программная инженерия и C++ для количественного анализа и и алгоритмической торговли» (МГУ, Мехмат).
...
```bash
# конфигурация проекта (создание файлов сборки)
cmake -S . -B build -DCMAKE_BUILD_TYPE=Release

# сборка всех целей (Приложение, Бенчмарк, Тесты)
...
Помимо него, можно посмотреть полную документацию API, сгенерированную Doxygen (включая диаграммы классов и математические формулы), доступна по ссылке:  https://lisadolgikh.github.io/ParallelMCOptionPricing/index.html
